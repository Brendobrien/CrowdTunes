...
///////////////////////
	...
	**/
	...
	// **/
		...
		$.ajax({
			...
			url: "./index_files/groupAdminData.txt",
	...
	**/
	    ...
	    $.ajax({
	        ...
	        url: "./index_files/bidSummariesData.txt",
	        success: function(data) {
...
//////////////////
	...
	**/
		...
		function setToTwoMonths(){
			...
			var thisMonth = lastday.getMonth()-1;
			// or if you wanted to include this month
			// var thisMonth = lastday.getMonth();
